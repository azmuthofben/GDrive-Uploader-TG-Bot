...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '6504389382:AAGiqASARUii1dxNQx0kH26mg8t3j6m2uwI' # Get it from https://t.me/BotFather
    APP_ID = '16732227' # Get it from my.telegram.org/apps
    API_HASH = '8b5594ad7ad37f3a0a7ddbfb3963bb51' # Get it from my.telegram.org/apps
    DATABASE_URL = 'postgres://odwapgwanbccmw:2ad7030f73597f786d956ebb61ece543ab986bddc05c2e13c1501e9f215e2f8e@ec2-52-5-167-89.compute-1.amazonaws.com:5432/dbjb63dkbahh6q' # SQL Database URL / Heroku Postgres URL
